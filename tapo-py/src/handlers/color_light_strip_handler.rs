...
#[derive(Clone)]
#[pyclass(name = "ColorLightStripHandler")]
pub struct PyColorLightStripHandler {
    handler: Arc<Mutex<ColorLightStripHandler>>,
}

impl PyColorLightStripHandler {
    pub fn new(handler: ColorLightStripHandler) -> Self {
        Self {
...
impl PyColorLightSetDeviceInfoParams {
    ...
    pub fn send<'a>(&'a self, py: Python<'a>, handler: PyColorLightStripHandler) -> PyResult<&'a PyAny> {
